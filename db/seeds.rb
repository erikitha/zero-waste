leite = Ingredient.create!(name: "milk", brand: "parmalat", category: "dairy")
leite2 =Ingredient.create!(name: "milk", brand: "fazenda", category: "dairy")
...
bolo_chocolate = Recipe.create!(name: "Bolo de Chocolate", prep_time: "60 min", description: "A melhor receita de bolo de chocolate!")
brigadeiro = Recipe.create!(name: "Brigadeiro", prep_time: "30 min", description: "Delicioso e prático!")
omelete = Recipe.create!(name: "Omelette du fromage", prep_time: "10 min", description: "O clássico frânces do renomado Chef Dexter!")
